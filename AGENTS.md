...
`.repos/effect-coding-agent` shows an example coding agent built using effect's primitives and unstable/ai module. While it is not following a hexagonal architecture, it is a good example. Consult it.
